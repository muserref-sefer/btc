...
const mockNewsSources = [
  {
    ...
    urlToImage:
      'https://i.abcnewsfe.com/a/ffa607e4-e710-4062-828d-e0f249456690/wirestory_9db43561dd4c1b580d44af73d05e0e08_16x9.jpg?w=1600',
  ...
  },
  {
    ...
    author:
      'MORIAH BALINGIT Associated Press, SUSAN MONTOYA BRYAN Associated Press, DYLAN LOVAN OF Associated Press, DANIEL BEEKMAN OF THE SEATTLE TIMES Associated Press',
    title:
    ...
    urlToImage:
      'https://i.abcnewsfe.com/a/2f4d52f0-12e6-4398-96da-c244ba9bac0f/wirestory_a3f6eb5b85dbe73e70e8d082421a7bef_16x9.jpg?w=1600',
    publishedAt: '2024-05-14T04:04:54Z',
    content:
      'ALBUQUERQUE, N.M. -- Across the country, the story for families is virtually the same: Child care is unaffordable for many, hard to find for those who can pay, and financially precarious for day care… [+6704 chars]'
  },
  {
    source: {
      id: 'abc-news',
    ...
    urlToImage:
      'https://i.abcnewsfe.com/a/57d764d1-262b-4759-83bb-719e300f63eb/wirestory_3d9a7f2f708ce407cf534fe1ea91fe28_16x9.jpg?w=1600',
  ...
  },
  {
    ...
    urlToImage:
      'https://i.abcnewsfe.com/a/87d83634-8e65-4fdf-b6c1-420195a3c7b2/wirestory_577fc889367669ff24b435afb719ec79_16x9.jpg?w=1600',
    publishedAt: '2024-05-14T00:54:08Z',
    content:
      "PHOENIX -- Arizona's highest court on Monday gave the state's attorney general another 90 days to decide further legal action in the case over a 160-year-old near-total ban on abortion that lawmakers… [+1893 chars]"
  }
]
...
describe('NewsSource Component Tests', () => {
  ...
  test('renders news sources when data is fetched successfully', async () => {
    ...
    global.fetch = jest.fn().mockResolvedValue({
      ok: true,
      json: () =>
        Promise.resolve({ status: 'ok', articles: mockNewsSources, total: 1 })
    })
    jest.useFakeTimers()
